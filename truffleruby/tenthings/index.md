...
RC 1, which is available today from [https://www.graalvm.org/downloads](https://www.graalvm.org/downloads). I'm using
...
[https://www.graalvm.org/downloads](https://www.graalvm.org/downloads), and put the programs from it onto my `$PATH`.
...
To try GraalVM go to [https://www.graalvm.org/](https://www.graalvm.org/). There
are links to downloads and documentation there, and more examples like we've
